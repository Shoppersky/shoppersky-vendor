...
//       const response = await axiosInstance.post("/vendor/reset-password/token", formData, {
...
//         if (status === 404) {
//           setError("No account found with this email or token.");
//         } else if (status === 403) {
//           setError("This account is inactive or not verified. Please contact support.");
//         } else if (status === 410) {
...
//   //           <h2 className="text-xl font-semibold text-slate-800 dark:text-slate-100 mb-2">Validating Reset Link</h2>
//   //           <p className="text-slate-600 dark:text-slate-400">Please wait while we verify your reset token...</p>
//   //         </CardContent>
//   //       </Card>
//   //     </div>
//   //   );
...
//                       Reset Password
//                     </h1>
//                     <p className="text-slate-600 dark:text-slate-400 font-medium">Create your new password</p>
//                   </div>
//                 </div>
