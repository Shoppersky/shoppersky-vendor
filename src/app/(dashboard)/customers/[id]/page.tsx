        ...
        >
          <CardHeader className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200">{order.product}</h2>
            </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex-1 space-y-1 text-gray-800 dark:text-gray-200">
                <p><span className="font-semibold">SKU:</span> {order.sku}</p>
                <p><span className="font-semibold">Category:</span> {order.category}</p>
                <p><span className="font-semibold">Variant:</span> {order.variant}</p>
                <p><span className="font-semibold">Quantity:</span> {order.quantity}</p>
                <p className="flex items-center gap-1"><DollarSign className="w-4 h-4 text-green-500"/> <span className="font-semibold">{order.amount}</span></p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-600 dark:text-gray-400">
              <div className="space-y-1">
                ...
                <p><span className="font-semibold">Shipping Status:</span> {order.shippingStatus}</p>
              </div>
              <div className="space-y-1">
                <p><span className="font-semibold">Payment Method:</span> {order.paymentMethod}</p>
                <p><span className="font-semibold">Payment Status:</span> {order.paymentStatus}</p>
                {order.customerNotes && <p><span className="font-semibold">Customer Notes:</span> {order.customerNotes}</p>}
              </div>
            </div>
