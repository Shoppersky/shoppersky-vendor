...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-hero overflow-hidden">
     ...
     <div className="absolute inset-0 bg-gradient-to-r from-yellow- via to-white" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <h1 className="text-5xl text-black lg:text-7xl font-bold leading-tight">
                Grow Your
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="shadow-button bg-gradient-to-r from-blue-500  to-purple-500 hover:shadow-xl transition-all duration-300 group">
                Start Selling Today
            ...
            <div className="grid grid-cols-3 gap-8 pt-8">
              <div className="text-center ">
                ...
                <div className="text-sm text-black font-bold">Uptime</div>
              </div>
              <div className="text-center">
                ...
                <div className="text-sm  text-black font-bold ">Daily Sales</div>
              </div>
              <div className="text-center">
                ...
                <div className="text-sm  text-black font-bold">Support</div>
              </div>
            </div>
          </div>
